...
--;;
alter table "public"."invoice" add constraint "pk_inv_id" primary key ("id");
--;;
...
--;;
alter table "public"."inv_item" add constraint "pk_inv_item_id" primary key ("id");
--;;
alter table "public"."inv_item" add constraint "fk_inv_item_inv_id" foreign key ("inv_id") references "public"."invoice" ("id") match full;
--;;
alter table "public"."inv_misc" add constraint "pk_inv_misc_id" primary key ("id");
--;;
alter table "public"."inv_misc" add constraint "fk_inv_misc_inv_id" foreign key ("inv_id") references "public"."invoice" ("id") match full;
--;;
alter table "public"."inv_discount" add constraint "pk_inv_discount_id" primary key ("id");
--;;
alter table "public"."inv_discount" add constraint "fk_inv_discount_inv_id" foreign key ("inv_id") references "public"."invoice" ("id") match full;
--;;
