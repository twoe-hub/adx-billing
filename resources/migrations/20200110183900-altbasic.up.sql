...
--;;
alter table "public"."quotation" add constraint "pk_quotation_id" primary key ("id");
--;;
...
--;;
alter table "public"."quotation" add constraint "uq_quotation_quote_no" unique ("quote_no");
--;;
